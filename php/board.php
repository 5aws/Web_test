...
<body>
		...
		&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
			<div class="container">  
				...
				<a class="navbar-brand" href="../index_auth.html">
					<img src="../images/33.PNG" alt="" width="95"/>
				</a>	&emsp;&emsp;&emsp;
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food"><br><br>
					<ul class="navbar-nav ml-auto">
						<li class="nav-item"><a class="nav-link" href="../index_auth.html">Home</a></li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">전체메뉴</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="#">자유여행</a>
								<ul>
									
									<li><a class="dropdown-item" href="#">미국/캐나다</a></li>
									<a class="dropdown-item" href="#">미국/캐나다</a>
								</ul>   
								
								<a class="dropdown-item" href="#">동남아</a>   
								<a class="dropdown-item" href="#">중국/일본</a> 
								<a class="dropdown-item" href="#">호주/뉴질랜드</a>    
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">자유여행</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="#"><font size="2em">유럽</font></a>   
								<a class="dropdown-item" href="#"><font size="2em">미국/캐나다</font></a>
								<a class="dropdown-item" href="#"><font size="2em">동남아</font></a>   
								<a class="dropdown-item" href="#"><font size="2em">중국/일본</font></a> 
								<a class="dropdown-item" href="#"><font size="2em">호주/뉴질랜드</font></a>   
								
							</div>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">패키지</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="#"><font size="2em">유럽</font></a>   
								<a class="dropdown-item" href="#"><font size="2em">미국/캐나다</font></a>
								<a class="dropdown-item" href="#"><font size="2em">동남아</font></a>   
						...
						<li class="nav-item"><a class="nav-link" href="#">항공</a></li>   <!--menu.html-->
						<li class="nav-item"><a class="nav-link" href="#">호텔</a></li> <!--about.html-->
						<li class="nav-item dropdown active">
							<a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">고객센터</a>
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								<a class="dropdown-item" href="#"><font size="2em">공지사항</font></a>   <!--reservation.html-->
								<a class="dropdown-item" href="#"><font size="2em">자주하는 질문</font></a>   <!--stuff.html-->
								<a class="dropdown-item" href="../php/board.php"><font size="2em">Q & A</font></a>     <!--gallery.html blog.html blog-details.html-->
								<a class="dropdown-item" href="#"><font size="2em">여행 후기</font></a>
							</div>
						</li>	
						<li class="nav-item"><a class="nav-link" href="../info_change.html"><font size="2em" color="gray">
							회원정보수정</font>
						 </a></li>
						<li class="nav-item"><a class="nav-link" href="../php/logout.php"><font size="2em" color="gray">
							로그아웃</font></a></li>
    ...
    <table class="table">
        <thead>
            <tr style="font-size:12pt;" bgcolor="#fee2c1" >
        ...
        <?php
                ...
                if (isset($_GET["page"])){
                    $start = $_GET["page"] * 10;
                    $page_sql = "SELECT * FROM board ORDER BY No DESC LIMIT $start, 10"; //start+1부터 10개 가져오겠다
                ...
                <td colspan=12>
                    ...
                    <div class='row'><br>
                        ...
                        <li class="<?php if ($page >= $page_count ) echo 'disabled'; ?>"> <!-- 마지막페이지일경우-->
                            <?php 
                                if ($page >= $page_count) {
                                ?>
                                    <a>Next</a>
